...
#
# Generated by Vivado on Sun Jan 24 21:06:36 CST 2021
...
# Script info
echo -e "axi_vip_0.sh - Script generated by export_simulation (Vivado v2020.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_vip_0 xil_defaultlib.axi_vip_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_vip_0 -key {Behavioral:sim_1:Functional:axi_vip_0} -tclbatch cmd.tcl -log simulate.log
}
