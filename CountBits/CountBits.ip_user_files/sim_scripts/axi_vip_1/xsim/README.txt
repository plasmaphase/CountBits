...
#
# Generated by export_simulation on Sun Jan 24 07:16:36 CST 2021
#
################################################################################
...
'-reset_run' switch to the './axi_vip_1.sh' script.

./axi_vip_1.sh -reset_run
...
./axi_vip_1.sh -noclean_files

For more information on the script, please type './axi_vip_1.sh -help'.
