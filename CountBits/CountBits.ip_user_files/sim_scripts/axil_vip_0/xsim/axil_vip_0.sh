...
#
# Generated by Vivado on Sun Jan 24 21:06:39 CST 2021
# SW Build 2960000 on Wed Aug  5 22:57:21 MDT 2020
#
# Copyright 1986-2020 Xilinx, Inc. All Rights Reserved. 
#
# usage: axil_vip_0.sh [-help]
# usage: axil_vip_0.sh [-lib_map_path]
# usage: axil_vip_0.sh [-noclean_files]
# usage: axil_vip_0.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "axil_vip_0.sh - Script generated by export_simulation (Vivado v2020.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_7 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axil_vip_0 xil_defaultlib.axil_vip_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axil_vip_0 -key {Behavioral:sim_1:Functional:axil_vip_0} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./axil_vip_0.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axil_vip_0.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./axil_vip_0.sh -help\" for more information)\n"
    exit 1
  fi
