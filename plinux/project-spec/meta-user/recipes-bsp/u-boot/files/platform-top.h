...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"qspiboot=run mmc_args; sf probe 0 && sf read 10000000 900000 1300000 && bootm ${netstart}; \0" \
	"mmc_args=setenv bootargs ${console} root=/dev/mmcblk0p1 rw earlyprintk rootfstype=ext4 rootwait devtmpfs.mount=1\0" \
""
